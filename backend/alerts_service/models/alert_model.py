...
class AlertSeverity(db.Model):
    ...
    name = db.Column(db.String(50), unique=True, nullable=False)   # CRITICA, ALTA, MEDIA, BAJA
    level = db.Column(db.Integer, nullable=False)                   # 1=CRITICA, 2=ALTA, 3=MEDIA, 4=BAJA
...
class Alert(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    device_id = db.Column(db.Integer, nullable=False)               # FK externa (devices_service)
